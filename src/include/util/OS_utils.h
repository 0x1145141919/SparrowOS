...
extern "C" int strcmp_in_kernel(const char *str1, const char *str2,uint32_t max_strlen=4096);
extern "C" int strlen_in_kernel(const char *s);
extern "C" int strncmp_in_kernel(const char* str1, const char* str2, size_t n);
